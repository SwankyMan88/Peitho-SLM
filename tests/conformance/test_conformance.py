"""Check every implementation against tests/conformance/vectors.json.
...
agrees with the stored numbers, so this runs all three against them.
    ...
    py tests/conformance/test_conformance.py
"""
...
def check_javascript(vectors):
    ...
    for line in result.stdout.splitlines():
        if line.startswith("ok "):
            ...
            check("javascript " + line[5:], False, "see tests/conformance/check.mjs output")
